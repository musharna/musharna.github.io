...
[github.com/musharna/orchid-sdxl](https://github.com/musharna/orchid-sdxl) — `phenotype_engine.py`, `crosses.py`, `phenotype_db.json` (119 species traits), `dominance_rules.json`, `app.py` (Gradio UI).
